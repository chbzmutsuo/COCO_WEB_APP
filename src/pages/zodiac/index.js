...
export default function Index() {
	...
	const gekkanshiMaster = [
		{ monthNum: [4, 9], 12: "丁丑", 1: "丙寅", 2: "丁卯", 3: "戊辰", 4: "己巳", 5: "庚午", 6: "辛未", 7: "壬申", 8: "癸酉", 9: "甲戌", 10: "乙亥", 11: "丙子", },
		{ monthNum: [5, 0], 12: "己丑", 1: "戊寅", 2: "己卯", 3: "庚辰", 4: "辛巳", 5: "壬午", 6: "癸未", 7: "甲申", 8: "乙酉", 9: "丙戌", 10: "丁亥", 11: "戊子", },
		{ monthNum: [6, 1], 12: "辛丑", 1: "庚寅", 2: "辛卯", 3: "壬辰", 4: "癸巳", 5: "甲午", 6: "乙未", 7: "丙申", 8: "丁酉", 9: "戊戌", 10: "己亥", 11: "庚子", },
		{ monthNum: [7, 2], 12: "癸丑", 1: "壬寅", 2: "癸卯", 3: "甲辰", 4: "乙巳", 5: "丙午", 6: "丁未", 7: "戊申", 8: "己酉", 9: "庚戌", 10: "辛亥", 11: "壬子", },
		{ monthNum: [8, 3], 12: "乙丑", 1: "甲寅", 2: "乙卯", 3: "丙辰", 4: "丁巳", 5: "戊午", 6: "己未", 7: "庚申", 8: "辛酉", 9: "壬戌", 10: "癸亥", 11: "甲子", },
	]
	...
	const culcurate = (e) => {
		...
		if (
			...
			birthMonth === '' ||
			birthDate === ''
		) { alert("生年月日を半角数字で正しく入力してください"); return }
		...
		setTimeout(() => {
			setresult({
				...result,
				nenkan: nenkanshiMaster.kan[birthYear % 10],
				gekkan: gekkanshi[0],
				nikkan: nikkanshi[0],
				nennshi: nenkanshiMaster.eto[birthYear % 12],
				gesshi: gekkanshi[1],
				nisshi: nikkanshi[1]
			})

			/**運勢確定 */
			const array = destinyMaster['kan'][nenkanshiMaster.kan[birthYear % 10]]
			let index = array.indexOf(nenkanshiMaster.eto[birthYear % 12])
			let dest = destinyMaster.result[index]
			setdestiny(dest)
		}, 300);

		/**記号表示 */
		const otherNameMaster = { "甲": "木", "乙": "花", "丙": "陽", "丁": "灯", "戊": "山", "己": "地", "庚": "鉄", "辛": "金", "壬": "海", "癸": "雨", }
		setotherName(otherNameMaster[nikkanshi[0]])
	}
	...
	return (
		<div className='bg- w-full h-full min-h-screen '>
			<div className=' text-center max-w-lg mx-auto  py-20 px-4 sm:p-16'>
				...
				<Form className='flex flex-wrap  max-w-md mx-auto'>
					<div className='w-1/3 p-1'>
						<FloatingLabel controlId="floatingInput" label="年" className="mb-3 text-yellow-600">
							<Form.Control type="number" placeholder="年" value={birthYear} onChange={(e) => {
					...
					<div className='w-1/3 p-1'>
						<FloatingLabel controlId="floatingInput" label="月" className="mb-3 text-yellow-600">
							<Form.Select type="number" placeholder="月" value={birthMonth} onChange={(e) => { setbirthMonth(e.target.value) }} >
					...
					<div className='w-1/3 p-1'>
						<FloatingLabel controlId="floatingInput" label="日" className="mb-3 text-yellow-600">
							<Form.Select type="number" placeholder="日" value={birthDate} onChange={(e) => { setbirthDate(e.target.value) }} >
								<option value=''>選択</option>
								{
									[...Array(31)].map((_, i) => {
										return <option key={i} value={i + 1}>{i + 1}</option>
				...
				<BtnBasic center onClick={culcurate}>鑑定</BtnBasic>
				{result && <div className='text-center m-10 flex flex-wrap  justify-center'>

					{/* <div>
						<p><dt>年干支</dt><dd>{result.nenkan + result.nennshi}</dd></p>

						<p><dt>月干支</dt><dd>{result.gekkan + result.gesshi}</dd></p>

						<p ><dt>日干支</dt><dd>{result.nikkan + result.nisshi}</dd></p>

						<p ><dt>運勢</dt><dd>{destiny}</dd></p>

						<p ><dt>別称</dt><dd>{otherName}</dd></p>
